...
@alf.configurable
class BafcAlgorithmV4(OffPolicyAlgorithm):
    ...
    V4 implements stochastic actor networks with an affine transformed random
    noise injected to the last layer, this design was from the StyleGAN.
    Functional critics are trained with instantiations of such stochastic actor 
    network with sampled noise injected.
