#!/bin/bash
# Launch the hopper:hop RLPD/BAFCv3/BAFCv3_TR2 comparison on seeds 0 and 1.
...
#
# Usage: bash run_hopper_hop_rlpd_bafcv3_seed01-4g.sh [options]
...
#
# Example:
#   bash run_hopper_hop_rlpd_bafcv3_seed01-4g.sh --dry-run
