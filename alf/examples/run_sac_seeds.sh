...
#
# Usage: bash run_sac_seeds.sh [options]
...
#
# Examples:
#   bash run_sac_seeds.sh -e walker:walk
#   bash run_sac_seeds.sh -e walker:walk -n 500000
#   bash run_sac_seeds.sh --env hopper:hop --steps 2000000 --dir /my/results
...
ROOT_DIR="${BASE_DIR}/${ENV_DIR}/sac_dmc"
