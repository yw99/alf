...
#
# Usage: bash run_rlpd_seeds-4g.sh [options]
...
#
# Examples:
#   bash run_rlpd_seeds-4g.sh -e walker:walk
#   bash run_rlpd_seeds-4g.sh -e walker:walk -n 500000
#   bash run_rlpd_seeds-4g.sh --env hopper:hop --steps 2000000 --dir /my/results
