#!/bin/bash
# Launch the quadruped:walk BAFCv3_TR2 jobs on seeds 0 and 1.
# Every job uses all four configured GPUs through DDP. The two jobs run in
...
#
# Example:
#   bash run_quadruped_walk_bafcv3_tr2_seed01-4g.sh --dry-run
...
if [[ "${DRY_RUN}" == "True" ]]; then
    ...
    echo "Launched two BAFCv3_TR2 4-GPU jobs: ${PIDS[*]}"
