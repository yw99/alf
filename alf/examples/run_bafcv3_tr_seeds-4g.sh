#!/bin/bash
# Launcher script for running BAFCv3-TR with 4 seeds in parallel
# Seeds 0,1,2,3 share GPUs 0,1,2,3
# Each seed uses 4 GPUs via DDP for 4 parallel environments
#
# Usage: bash run_bafcv3_tr_seeds-4g.sh [options]
...
#
# Examples:
#   bash run_bafcv3_tr_seeds-4g.sh -e walker:walk
#   bash run_bafcv3_tr_seeds-4g.sh -e walker:walk -n 500000
#   bash run_bafcv3_tr_seeds-4g.sh --env hopper:hop --steps 2000000 --dir /my/results
...
ROOT_DIR="${BASE_DIR}/${ENV_DIR}/bafcv3_tr_dmc_4g"

echo "Starting BAFCv3-TR training with 4 seeds on shared GPUs 0,1,2,3"
