...
#
# Usage: bash run_td3v2_seeds.sh [options]
...
#
# Examples:
#   bash run_td3v2_seeds.sh -e walker:walk
#   bash run_td3v2_seeds.sh -e walker:walk -n 500000
#   bash run_td3v2_seeds.sh --env hopper:hop --steps 2000000 --dir /my/results
