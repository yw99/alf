...
#
# Examples:
#   bash run_bafcv3_seeds.sh -e walker:walk
#   bash run_bafcv3_seeds.sh -e walker:walk -n 500000
#   bash run_bafcv3_seeds.sh --env hopper:hop --steps 2000000 --dir /my/results
...
ROOT_DIR="${BASE_DIR}/${ENV_DIR}/bafcv3_dmc"

echo "Starting BafcV3 training with 4 seeds"
