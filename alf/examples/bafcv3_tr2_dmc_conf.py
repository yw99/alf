...
alf.define_config('bafcv3_tr2_actor_critic_pairing', True)
actor_critic_pairing = alf.get_config_value(
    'bafcv3_tr2_actor_critic_pairing')
alf.define_config('bafcv3_tr2_num_actor_critic', 10)
num_actor_critic = alf.get_config_value('bafcv3_tr2_num_actor_critic')
alf.define_config('bafcv3_tr2_num_sampled_critics_for_actor', 1)
num_sampled_critics_for_actor = alf.get_config_value(
    'bafcv3_tr2_num_sampled_critics_for_actor')
alf.define_config('bafcv3_tr2_use_random_critic_targets', False)
use_random_critic_targets = alf.get_config_value(
    'bafcv3_tr2_use_random_critic_targets')
alf.define_config('bafcv3_tr2_num_sampled_critic_targets', 1)
num_sampled_critic_targets = alf.get_config_value(
    'bafcv3_tr2_num_sampled_critic_targets')
