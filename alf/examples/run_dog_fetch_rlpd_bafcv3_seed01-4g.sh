...
#
# Usage: bash run_dog_fetch_rlpd_bafcv3_seed01-4g.sh [options]
...
#
# Example:
#   bash run_dog_fetch_rlpd_bafcv3_seed01-4g.sh --dry-run
...
# Keep the task in the path so dog:fetch cannot reuse dog:walk checkpoints.
ENV_DIR="${ENV_NAME//:/_}"
ROOT_DIR="${BASE_DIR}/${ENV_DIR}/rlpd_bafcv3_comparison_4g"

cat <<EOF
Starting dog:fetch RLPD/BAFCv3/BAFCv3_TR2 comparison
