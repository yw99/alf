...
for i in "${!GPU_IDS[@]}"; do
    ...
    RUN_DIR="${ROOT_BASE}/eval${EVAL_TRUST_MAX}_nf${NUM_FEATURE_COORDS}_mi${METRIC_INTERVAL}_cap${ROLLOUT_SKIP_CAP}_seed${SEED}${RUN_SUFFIX}_ln${ACTOR_USE_LN}"
    mkdir -p "${RUN_DIR}"
