#!/bin/bash
# Launch the quadruped:walk RLPD/BAFCv3 comparison on seeds 2 and 3.
...
#
# Usage: bash run_quadruped_walk_rlpd_bafcv3_seed23-4g.sh [options]
...
#
# Example:
#   bash run_quadruped_walk_rlpd_bafcv3_seed23-4g.sh --dry-run
