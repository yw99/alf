#!/bin/bash
# Launcher script for running TD3 with 4 seeds in parallel
...
#
# Examples:
#   bash run_td3_seeds.sh -e walker:walk
#   bash run_td3_seeds.sh -e walker:walk -n 500000
#   bash run_td3_seeds.sh --env hopper:hop --steps 2000000 --dir /my/results
...
echo "Starting TD3 training with 4 seeds"
