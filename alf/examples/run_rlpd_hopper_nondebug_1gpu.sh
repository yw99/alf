#!/bin/bash
# Launcher for one or more RLPD hopper runs.
#
# Usage: bash run_rlpd_hopper_nondebug_1gpu.sh [options]
...
#
# Examples:
#   bash run_rlpd_hopper_nondebug_1gpu.sh --gpu 0 --seed 0
#   bash run_rlpd_hopper_nondebug_1gpu.sh --gpus 0,1,2,3 --seeds 0,1,2,3
