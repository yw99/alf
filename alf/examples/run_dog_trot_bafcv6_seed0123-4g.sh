#!/bin/bash
# Launch the BAFCv6 random-target condition on dog:trot seeds 0–3.
...
#
# Usage: bash run_dog_trot_bafcv6_seed0123-4g.sh [options]
...
#
# Example:
#   bash run_dog_trot_bafcv6_seed0123-4g.sh --dry-run
...
ROOT_DIR="${BASE_DIR}/dog_trot/bafcv6_seed0123_4g_rerun_20260916/num_actor_critic${NUM_ACTOR_CRITIC}_num_sampled_critics_for_actor${NUM_SAMPLED_CRITICS_FOR_ACTOR}_num_sampled_critic_targets${NUM_SAMPLED_CRITIC_TARGETS}/critic_utd${CRITIC_UTD}"
...
cat <<EOF
Starting BAFCv6 dog:trot seeds 0–3
  Config: ${CONF_FILE}
  Root dir: ${ROOT_DIR}
