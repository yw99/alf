...
#
# Usage: bash run_humanoid_walk_rlpd_bafcv3_seed23-4g.sh [options]
...
#
# Example:
#   bash run_humanoid_walk_rlpd_bafcv3_seed23-4g.sh --dry-run
...
cat <<EOF
Starting humanoid:walk RLPD/BAFCv3/BAFCv3_TR2 comparison
