...
alf.config('Agent',
           optimizer=optimizer,
           rl_algorithm_cls=Td3Algorithm2)
...
alf.config(
    ...
    # Delayed policy updates (original TD3 paper: update actor every 2 critic updates)
    policy_delay=2,
...
alf.config(
    ...
    num_updates_per_train_iter=1,  # Original TD3 uses 1 update per env step
